...
export default class Lights extends React.Component {
    ...
    setLight(lightId, brightness) {
        ...
        axios
            .put(
                'http://192.168.1.3/api/ZrQtiubwFZ4uF-1UnlUSgg9HDbb3MByoUuGBb6DX/lights/' + lightId + '/state',
                options
            )
            .then(response => {
    ...
    render() {
        console.log('here');
        axios
            .get('http://192.168.1.3/api/ZrQtiubwFZ4uF-1UnlUSgg9HDbb3MByoUuGBb6DX/groups')
            .then(response => {
                console.log(response.data);
