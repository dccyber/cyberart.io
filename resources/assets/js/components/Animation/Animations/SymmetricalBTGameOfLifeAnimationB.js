...
class SymmetricalBTGameOfLifeAnimationB extends StateMachineAnimation {

    constructor (height, width) {

        //TODO: refactor this with SymmetricalBTGameOfLifeAnimationB to just pass in different initial states
        const initialStateGenerator = (i, j) => {

            // Structured start
            let alive = i > j - 6 && i < j + 6 && ((i+j) % 8 == 0 || (i+j) % 7 == 0 || (i+j) % 6 == 0);
            return {
                alive: alive,
                age: alive ? 1 : 0,
                blooming: 0,
