...
class GameOfLifeAnimation extends StateMachineAnimation {
    ...
    constructor (height, width) {
        ...
        const colorGenerator = (cellState, framesElapsed) => {
            return {
                red: cellState.alive ? Math.min(cellState.age, 255) : 0,
                green: cellState.alive ? Math.min(255 - cellState.age, 255) : 0,
                blue: cellState.alive ? 0 : cellState.blooming,//cellState.alive ? Math.min(cellState.age, 255) : 0,
        ...
        super(height, width, initialStateGenerator, stateTransition, colorGenerator, 'Game of Life');
    }
