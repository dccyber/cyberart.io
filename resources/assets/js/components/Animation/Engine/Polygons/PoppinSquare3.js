class PoppinSquare3 {
    ...
    switch (Math.ceil(this.idx / 256)) {
      case 1:
        color = Math.floor(
          256 *
            Math.sin(
              (Math.PI * this.idx * (framesElapsed / (140 - this.strength))) /
                256
            )
        );
        break;
      case 2:
        color = Math.floor(
          256 *
            Math.sin(
              (Math.PI * this.idx * (framesElapsed / (180 - this.strength))) /
                256
            )
        );
        break;
      case 3:
        color = Math.floor(
          256 *
            Math.sin(
              (Math.PI * this.idx * (framesElapsed / (220 - this.strength))) /
                256
            )
        );
        break;
      case 4:
        color = Math.floor(
          256 *
            Math.sin(
              (Math.PI * this.idx * (framesElapsed / (260 - this.strength))) /
                256
            )
        );
        break;
  ...
  draw(ctx, framesElapsed) {
    ...
    ctx.rotate(
      (((this.idx * (framesElapsed + this.strength)) / 256) * Math.PI) / 180
    );
    ctx.translate(-this.x, -this.y);
