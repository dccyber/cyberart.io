class EqRect {
  ...
  red(ctx, framesElapsed) {
    let color = Math.floor(
      (256 * (Math.sin((Math.sin(framesElapsed / 23) * this.idx) / 197) + 1)) /
        2
    );
  ...
  blue(ctx, framesElapsed) {
    let color = Math.floor(
      (256 * (Math.sin((Math.sin(framesElapsed / 17) * this.idx) / 203) + 1)) /
        2
    );
  ...
  green(ctx, framesElapsed) {
    let color = Math.floor(
      (256 * (Math.sin((Math.sin(framesElapsed / 29) * this.idx) / 397) + 1)) /
        2
    );
