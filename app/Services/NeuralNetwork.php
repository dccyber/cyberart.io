 ...
 *
 * Loosely based on source code by {@link http://www.philbrierley.com Phil Brierley}, that was translated into PHP by 'dspink' in sep 2005
 *
...
class NeuralNetwork
{
     ...
     *
     * @param array $neuralNetParams An array of the neural network parameters
     * @return NeuralNetwork
     */
    public function import(array $neuralNetParams) :NeuralNetwork
    {
        foreach ($neuralNetParams as $key => $value)
        {
            $this->$key = $value;
        }
     ...
     */
    public function getLearningRate(int $layer) :float
    {
     ...
     */
    public function setMomentum(float $momentum)
    {
     ...
     */
    protected function activation(float $value) :float
    {
        return tanh($value);
     ...
     * @return $float
     */
    protected function derivativeActivation(float $value) :float
    {
        $tanh = tanh($value);
     ...
     */
    public function addTestData(array $input, array $output, int $id = null)
    {
     ...
     */
    public function getTestDataIDs() :array
    {
     ...
     * @param int $id (optional) An identifier for this piece of data
     */
    public function addControlData(array $input, array $output, int $id = null)
    {
     ...
     * @return array An array of identifiers
     */
    public function getControlDataIDs() :array
    {
     ...
     */
    public function showWeights(bool $force = false)
    {
     ...
     */
    public function setVerbose(bool $isVerbose)
    {
     ...
     */
    public function train(int $maxEpochs = 500, float $maxError = 0.01) :bool
    {
...
//				echo "<td>output = (" . implode(", ", $output) .")</td></tr>";
     ...
     */
    private function setErrorTrainingSet(float $error)
    {
     ...
     */
    public function getErrorTrainingSet() :float
    {
     ...
     */
    private function setErrorControlSet(float $error)
    {
     ...
     */
    public function getErrorControlSet() :float
    {
     ...
     */
    private function setTrainingSuccessful(bool $success)
    {
     ...
     * @return bool 'true' if the training was successful, 'false' otherwise
     */
    public function getTrainingSuccessful() :bool
    {
        return $this->success;
    }
     ...
     */
    private function fitLine(array $data) :array
    {
        // based on
     ...
     *
     * TODO: what is the purpose of $layer? It is unused
     *
     * @return float A random weight
     */
    private function getRandomWeight($layer) :float
    {
     ...
     */
    private function backpropagate(array $output, array $desired_output)
    {
        $errorgradient = [];
    ...
    /**
     * Calculate the root-mean-squared error of the output, given the training data.
     *
     * @return float The root-mean-squared error of the output
     */
    private function squaredErrorEpoch() :float
    {
        $RMSerror = 0.0;
        for ($i = 0; $i < count($this->trainInputs); $i ++) {
    ...
    /**
     * Calculate the root-mean-squared error of the output, given the control data.
     *
     * @return float The root-mean-squared error of the output
     */
    private function squaredErrorControlSet() :float
    {
     ...
     */
    private function squaredError(array $input, array $desired_output) :float
    {
        $output = $this->calculate($input);
